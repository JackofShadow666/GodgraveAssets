...
//   настроек sl-lmbcost, по умолчанию 50%). 1.0 = обычная стоимость (50%),
//   0.5 = вдвое дешевле (25%, как у рапиры). Если не указано — 1.0.
...
// 1.0 = обычная стоимость (по умолчанию 50% из настроек), 0.5 = вдвое дешевле (25%).
