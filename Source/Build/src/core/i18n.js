...
'slider.cameraEdgeMargin': 'Отступ камеры от края (клетки)',
'slider.cameraEdgeDelay': 'Задержка центрирования камеры (сек.)',
...
'checkbox.autoStance': 'Автоматическая стойка по ближайшему врагу',
...
'checkbox.debugBotState': 'Отладка: состояние бота внизу экрана',
...
'badge.title': 'БОЙ НА МЕЧАХ',
    ...
    'survival.victory': '🏆 АРЕНА ПРОЙДЕНА',
    ...
    'survival.heal': '+50 HP',
    'survival.healed': '+{amount} HP',
    'survival.enemies': 'ВРАГОВ: {count}',
    'survival.kills': 'УБИЙСТВ: {count}',
    'survival.respawnIn': 'ИГРОК {slot}: ВОЗРОЖДЕНИЕ {seconds} С',
    'survival.locked': 'В арене состав волн и оружие задаёт режим',
    'factions.ffa.playerWin': '🏆 ПОБЕДА ИГРОКА',
    'factions.ffa.botsWin': '🤖 ПОБЕДА БОТОВ',
    'weapon.sword': 'Меч',
    'weapon.rapier': 'Рапира',
    'weapon.tapesword': 'Ленточный меч',
    ...
    'mobile.controls.slowmo': 'Замедление времени',
  ...
  const STRINGS = {
    en: {
      ...
      rows: {
        ...
        camedge: 'Отступ края камеры',
        camdelay: 'Задержка центрирования камеры',
      ...
      staticText: {
        ...
        '#local-faction-mode option[value="survival"]': 'Арена',
